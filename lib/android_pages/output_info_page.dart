...
class OutputInfoPage extends StatelessWidget {
  OutputInfoPage({super.key});
                    ...
                    onPressed: () async {
                      try {
                        ...
                        if (result.isNotEmpty &&
                          ...
                          await dataProvider.deleteOutput(context: context);
        ...
        body: Stack(
          children: [
            ...
            Container(
              ...
              alignment: Alignment.center,
              child: FutureBuilder(
                future: dataProvider.getOutputDocumentReference.get(),
                  ...
                  if (!snapshot.hasData) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () async {
                            if (snapshot.data?["notes"].toString() != null) {
                              notes.text = snapshot.data!["notes"].toString();
                            }
